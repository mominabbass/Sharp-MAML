...
class ModelAgnosticMetaLearning(object):
    ...
    """
    def __init__(self, model, optimizer=None, step_size=0.1,  adap=False, alpha=0.05, SAM_lower=False, first_order=False,
    ...
    def get_outer_loss(self, batch):
        ...
        for task_id, (train_inputs, train_targets, test_inputs, test_targets) \
            ...
            params, adaptation_results = self.adapt(self.adap, self.alpha, self.SAM_lower, train_inputs, train_targets,
    ...
    def adapt(self, adap, alpha, SAM_lower, inputs, targets, is_classification_task=None,
        ...
        for step in range(num_adaptation_steps):
            ...
            params = gradient_update_parameters(self.model, inner_loss, inputs, targets,
                step_size=step_size, params=params, adaptive=adap,
                                            alpha=alpha, sam_lower=SAM_lower, first_order=(not self.model.training) or first_order)
            # gradient_update_parameters_new(self.model, inputs, targets, inner_loss, step_size=step_size,
            #                                first_order=first_order, adaptive=adap,
            #                                alpha=alpha, sam_lower=SAM_lower)
