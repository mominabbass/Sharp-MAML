...
def train(args):
    ...
    file_name = 'results_BiESAM_{}_beta{}_gamma{}_miniimagenet_5way_1shot_lower_t2.npy'.format(args.rho, args.beta, args.gamma)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--trial', type=int, default=1, help='trial for different run')
