...
data_nsam_t1_1shot_t1 = np.load('save_results_min/results_MAML_miniimagenet_1shot_t1.npy')
data_sam_t1_1shot_rho3_t1 = np.load('save_results_min/results_BiSAM_0.05_miniimagenet_1shot_t1.npy')
data_sam_t1_1shot_rho4_t1 = np.load('save_results_min/results_BiSAM_0.005_miniimagenet_1shot_t1.npy')
data_sam_t1_1shot_rho5_t1 = np.load('save_results_min/results_BiSAM_0.0005_miniimagenet_1shot_t1.npy')
data_sam_t1_1shot_rho6_t1 = np.load('save_results_min/results_BiSAM_5e-05_miniimagenet_1shot_t1.npy')

data_nsam_t1_1shot_t2 = np.load('save_results_min/results_MAML_miniimagenet_1shot_t2.npy')
data_sam_t1_1shot_rho3_t2 = np.load('save_results_min/results_BiSAM_0.05_miniimagenet_1shot_t2.npy')
data_sam_t1_1shot_rho4_t2 = np.load('save_results_min/results_BiSAM_0.005_miniimagenet_1shot_t2.npy')
data_sam_t1_1shot_rho5_t2 = np.load('save_results_min/results_BiSAM_0.0005_miniimagenet_1shot_t2.npy')
data_sam_t1_1shot_rho6_t2 = np.load('save_results_min/results_BiSAM_5e-05_miniimagenet_1shot_t2.npy')

data_nsam_t1_1shot_t3 = np.load('save_results_min/results_MAML_miniimagenet_1shot_t3.npy')
data_sam_t1_1shot_rho3_t3 = np.load('save_results_min/results_BiSAM_0.05_miniimagenet_1shot_t3.npy')
data_sam_t1_1shot_rho4_t3 = np.load('save_results_min/results_BiSAM_0.005_miniimagenet_1shot_t3.npy')
data_sam_t1_1shot_rho5_t3 = np.load('save_results_min/results_BiSAM_0.0005_miniimagenet_1shot_t3.npy')
data_sam_t1_1shot_rho6_t3 = np.load('save_results_min/results_BiSAM_5e-05_miniimagenet_1shot_t3.npy')
...
print('max accuracy (trial 1) MAML                  (5-way 1-shot) (in first 1000 epochs):  {} (in {} epochs)'.format(np.max(test_acc_nsam_t1_1shot_t1[0:1000]), np.argmax(test_acc_nsam_t1_1shot_t1[0:1000])))
print('max accuracy (trial 1) MAML+SAM rho=0.05    (5-way 1-shot) (in first 1000 epochs):  {} (in {} epochs)'.format(np.max(test_acc_sam_t1_1shot_rho3_t1[0:1000]), np.argmax(test_acc_sam_t1_1shot_rho3_t1[0:1000])))
print('max accuracy (trial 1) MAML+SAM rho=0.005   (5-way 1-shot) (in first 1000 epochs):  {} (in {} epochs)'.format(np.max(test_acc_sam_t1_1shot_rho4_t1[0:1000]), np.argmax(test_acc_sam_t1_1shot_rho4_t1[0:1000])))
print('max accuracy (trial 1) MAML+SAM rho=0.0005  (5-way 1-shot) (in first 1000 epochs):  {} (in {} epochs)'.format(np.max(test_acc_sam_t1_1shot_rho5_t1[0:1000]), np.argmax(test_acc_sam_t1_1shot_rho5_t1[0:1000])))
print('max accuracy (trial 1) MAML+SAM rho=0.00005 (5-way 1-shot) (in first 1000 epochs):  {} (in {} epochs)\n'.format(np.max(test_acc_sam_t1_1shot_rho6_t1[0:1000]), np.argmax(test_acc_sam_t1_1shot_rho6_t1[0:1000])))
...
print('max accuracy (trial 2) MAML+SAM rho=0.05    (5-way 1-shot) (in first 1000 epochs): \t {} (in {} epochs)'.format(np.max(test_acc_sam_t1_1shot_rho3_t2[0:1000]), np.argmax(test_acc_sam_t1_1shot_rho3_t2[0:1000])))
print('max accuracy (trial 2) MAML+SAM rho=0.005   (5-way 1-shot) (in first 1000 epochs): \t {} (in {} epochs)'.format(np.max(test_acc_sam_t1_1shot_rho4_t2[0:1000]), np.argmax(test_acc_sam_t1_1shot_rho4_t2[0:1000])))
print('max accuracy (trial 2) MAML+SAM rho=0.0005  (5-way 1-shot) (in first 1000 epochs): \t {} (in {} epochs)'.format(np.max(test_acc_sam_t1_1shot_rho5_t2[0:1000]), np.argmax(test_acc_sam_t1_1shot_rho5_t2[0:1000])))
print('max accuracy (trial 2) MAML+SAM rho=0.00005 (5-way 1-shot) (in first 1000 epochs): \t {} (in {} epochs)\n'.format(np.max(test_acc_sam_t1_1shot_rho6_t2[0:1000]), np.argmax(test_acc_sam_t1_1shot_rho6_t2[0:1000])))
...
print('max accuracy (trial 3) MAML+SAM rho=0.05    (5-way 1-shot) (in first 1000 epochs): {} (in {} epochs)'.format(np.max(test_acc_sam_t1_1shot_rho3_t3[0:1000]), np.argmax(test_acc_sam_t1_1shot_rho3_t3[0:1000])))
print('max accuracy (trial 3) MAML+SAM rho=0.005   (5-way 1-shot) (in first 1000 epochs): {} (in {} epochs)'.format(np.max(test_acc_sam_t1_1shot_rho4_t3[0:1000]), np.argmax(test_acc_sam_t1_1shot_rho4_t3[0:1000])))
print('max accuracy (trial 3) MAML+SAM rho=0.0005  (5-way 1-shot) (in first 1000 epochs): {} (in {} epochs)'.format(np.max(test_acc_sam_t1_1shot_rho5_t3[0:1000]), np.argmax(test_acc_sam_t1_1shot_rho5_t3[0:1000])))
print('max accuracy (trial 3) MAML+SAM rho=0.00005 (5-way 1-shot) (in first 1000 epochs): {} (in {} epochs)\n'.format(np.max(test_acc_sam_t1_1shot_rho6_t3[0:1000]), np.argmax(test_acc_sam_t1_1shot_rho6_t3[0:1000])))
...
print('max avg accuracy (3 trials) MAML+SAM rho=0.05    (5-way 1-shot) (in first 1000 epochs): {} (in {} epochs)'.format(np.max(test_acc_sam_t1_1shot_rho3_avg[0:1000]), np.argmax(test_acc_sam_t1_1shot_rho3_avg[0:1000])))
print('max avg accuracy (3 trials) MAML+SAM rho=0.005   (5-way 1-shot) (in first 1000 epochs): {} (in {} epochs)'.format(np.max(test_acc_sam_t1_1shot_rho4_avg[0:1000]), np.argmax(test_acc_sam_t1_1shot_rho4_avg[0:1000])))
print('max avg accuracy (3 trials) MAML+SAM rho=0.0005  (5-way 1-shot) (in first 1000 epochs): {} (in {} epochs)'.format(np.max(test_acc_sam_t1_1shot_rho5_avg[0:1000]), np.argmax(test_acc_sam_t1_1shot_rho5_avg[0:1000])))
print('max avg accuracy (3 trials) MAML+SAM rho=0.00005 (5-way 1-shot) (in first 1000 epochs): {} (in {} epochs)\n'.format(np.max(test_acc_sam_t1_1shot_rho6_avg[0:1000]), np.argmax(test_acc_sam_t1_1shot_rho6_avg[0:1000])))
...
plt.legend(['MAML',
			...
			'MAML+SAM (rho={})'.format(rho5),
			'MAML+SAM (rho={})'.format(rho6),
			#'MAML+SAM (rho={})'.format(rho7),
			])
plt.savefig("./save_results_min/test_loss_miniimagenet.png", dpi=600)
plt.show()
...
plt.savefig("./save_results_min/test_acc_miniimagenet.png", dpi=600)
plt.show()
