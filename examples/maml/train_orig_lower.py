...
def train(args):
    ...
    file_name = 'results_BiSAM_{}_omniglot_20way_1shot_lower_t{}.npy'.format(args.rho, args.trial)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--rho', type=float, default=0.05, help='radius rho for SAM')
