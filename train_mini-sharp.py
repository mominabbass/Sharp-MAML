...
def main(args):
    ...
    if (args.output_folder is not None):
        ...
        folder = os.path.join(args.output_folder,
                              time.strftime('%Y-%m-%d_%H%M%S_omni_sharp_upper_{}_{}_{}_shots_{}_epochs_{}'.format(args.alpha, args.step_size, args.num_steps, args.num_shots, args.num_epochs)))
        os.makedirs(folder)
...
if __name__ == '__main__':
    ...
    #SAM
    parser.add_argument('--alpha', type=float, default=0.05, help='perturbation radius alpha for SAM')
    ...
    parser.add_argument('--m', type=int, default=1,
                        help='Number of batches for the ascent step')
